...
opts_chunk$set(fig.path=paste0(VAR, 'public/images/2016-05-26-Gerber_Statistic_and_Hierarchical_Risk_Parity/'),tidy=FALSE, size='scriptsize', fig.align='center',  fig.width=5,  fig.height=3, message=FALSE,warning=FALSE, results = 'hide', echo=F)

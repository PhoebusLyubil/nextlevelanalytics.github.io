...
In the research paper, it is stated that MPT using the Gerber Statistic outperformed that using historical correlation as measured by ex-post returns under realistic investment constraints, including transaction costs, for a range of investor types, for an investment universe of global stock indices, bonds and commodities, for the period January 1994 to December 2013.
...
#### Speed Comparison
Finally, let's compare the speed gain result. The test data is based on a return matrix of 30 securities with 2500 data poitns. It can be seen that the OpenMP version of the calculation is __more than 150x__ faster than the R version. (The machine used is Interl(R) Xeon(R) CPU E3-1271 v2 @ 3.60GHz)


|Implementation        | replications| elapsed| relative|
|:---------------------|------------:|-------:|--------:|
|R Version             |          500|   0.718|    1.000|
|Rcpp Version          |          500|  77.377|  107.767|
|Rcpp + OpenMP Version |          500| 122.747|  170.957|
